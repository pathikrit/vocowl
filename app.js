...
(function() {
  var clearTimeoutId, dbUrl, define, descHash, dic, dics, f, hash, i, j, lists, loadShare, meny, showChoiceId, tour, types, wordCache, _i, _j, _len, _len1,
  ...
  loadShare = function() {
    return $.getScript('https://s7.addthis.com/js/300/addthis_widget.js#pubid=ra-51b93bef4bd3bd5b&domready=1', function() {
      var addthis_config, addthis_share;
      addthis_config = {
        data_ga_tracker: 'UA-42001818-1'
      };
      addthis_share = {
        url: 'vocowl.com',
        title: 'Vocowl',
        description: 'Vocowl is awesome!'
      };
      addthis.init();
      return $('.addthis_toolbox').append('<iframe src="http://ghbtns.com/github-btn.html?user=pathikrit&repo=vocowl&type=watch&count=true" allowtransparency="true" frameborder="0" scrolling="0" width="152px" height="30px"></iframe>');
    });
  };

  setTimeout(loadShare, 7000);
